...
{
    /// <summary>
    /// Used for plugins that require persistent storage.
    /// </summary>
    public interface IPersistentPlugin : IPlugin
    {
        /// <summary>
        /// The path to a directory where the plugin should store its persistent data.
        /// <para>The directory is created during the plugin load process.</para>
        /// </summary>
        string PersistentDirectory { set; }
    }
}
