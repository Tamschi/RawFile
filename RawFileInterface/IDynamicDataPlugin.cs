...
{
    /// <summary>
    /// Used for plugins of wich the supported data identifiers can change.
    /// </summary>
    public interface IDynamicDataPlugin : IDataPlugin
    {
        /// <summary>
        /// Used for signaling that the plugin's supported data identifiers changed.
        /// </summary>
        Action DataIdentifiersChanged { set; }
    }
}
