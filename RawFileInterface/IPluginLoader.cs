...
{
    /// <summary>
    /// Used for plugins that load other plugins.
    /// </summary>
    public interface IPluginLoader : IPlugin
    {
        /// <summary>
        /// Called by the plugin to register a new plugin.
        /// The Assembly is loaded and instantiated by the IPluginLoader plugin.
        /// </summary>
        Action<IPlugin> RegisterPlugin { set; }
    }
}
