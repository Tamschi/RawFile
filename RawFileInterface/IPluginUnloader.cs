...
{
    /// <summary>
    /// Used for plugins that unload plugins.
    /// </summary>
    public interface IPluginUnloader : IPlugin
    {
        /// <summary>
        /// Invoked to unload a plugin and remove it from all data and file ids.
        /// </summary>
        Action<IPlugin> UnloadPlugin { set; }
    }
}
