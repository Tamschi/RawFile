...
{
    /// <summary>
    /// Used for plugins that need to do computations after other properties have been set.
    /// <para>IDataPlugins and IFilePlugins should do this when an UIElement is requested instead.</para>
    /// </summary>
    public interface ILateActivatedPlugin : IPlugin
    {
        /// <summary>
        /// Called after properties have been set and current plugins were loaded.
        /// </summary>
        void ActivateLate();
    }
}
