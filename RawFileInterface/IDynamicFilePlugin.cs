...
{
    /// <summary>
    /// Used for plugins of wich the supported file identifiers can change.
    /// </summary>
    public interface IDynamicFilePlugin : IFilePlugin
    {
        /// <summary>
        /// Used for signaling that the plugin's supported file identifiers changed.
        /// </summary>
