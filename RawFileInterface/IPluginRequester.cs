...
{
    /// <summary>
    /// Used for plugins that list plugins.
    /// </summary>
    public interface IPluginRequester : IPlugin
    {
        /// <summary>
        /// Used to request a list of all currently loaded plugins.
        /// </summary>
        Func<IPlugin[]> PluginsRequest { set; }

        /// <summary>
        /// Used to request a list of plugins for a data id.
        /// </summary>
        Func<string, IDataPlugin[]> DataPluginsRequest { set; }

        /// <summary>
        /// Used to request a list of plugins for a file id.
        /// </summary>
        Func<string, IFilePlugin[]> FilePluginsRequest { set; }
    }
}
